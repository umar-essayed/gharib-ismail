...
<h5 class="text-center mb-3">مرتجع شراء <?= e($row['return_no']) ?></h5>
<table class="table table-bordered"><thead><tr><th>الصنف</th><th>الكمية</th><th>السعر</th><th>الإجمالي</th></tr></thead><tbody><?php foreach($row['items'] as $item): ?><tr><td><?= e($item['product_name']) ?></td><td><?= money($item['qty']) ?></td><td><?= money($item['unit_price']) ?></td><td><?= money($item['line_total']) ?></td></tr><?php endforeach; ?></tbody></table>
