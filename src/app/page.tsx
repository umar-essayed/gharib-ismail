    ...
    <div className="flex-1 flex flex-col min-h-screen bg-slate-50 font-sans text-right">
                ...
                <div className="absolute bottom-6 right-6 left-6 sm:bottom-12 sm:right-12 sm:left-12 z-20 text-white space-y-2 sm:space-y-4 max-w-xl">
                  ...
                  <div className="pt-1 sm:pt-2">
                    <Link
                      ...
                      className="bg-primary hover:bg-primary-dark text-white font-extrabold px-4 py-2 sm:px-6 sm:py-2.5 rounded-xl text-[10px] sm:text-xs shadow-md transition-all inline-block hover:-translate-y-0.5"
                    >
                      اكتشف العرض الآن 🛒
                    </Link>
                  </div>
            ...
            {banners.length > 1 && (
              <>
                <button
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 z-20 bg-white/20 hover:bg-white/40 text-white w-8 h-8 rounded-full flex items-center justify-center backdrop-blur-xs transition-all cursor-pointer opacity-0 group-hover:opacity-100 select-none text-xs"
                >
                  ❮
                </button>
                <button
                  onClick={() => setCurrentSlide(prev => (prev + 1) % banners.length)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 z-20 bg-white/20 hover:bg-white/40 text-white w-8 h-8 rounded-full flex items-center justify-center backdrop-blur-xs transition-all cursor-pointer opacity-0 group-hover:opacity-100 select-none text-xs"
                >
                  ❯
                </button>
              </>
        ...
        <section className="relative overflow-hidden text-slate-900 py-24 sm:py-32 bg-white border-b border-slate-200/50">
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center space-y-6 z-10">
            ...
            <p className="text-xs sm:text-sm text-slate-600 max-w-md font-bold leading-relaxed">
              تسوّق الآن واحصل على عروض المواد الغذائية، المجمدات، والبقالة بأفضل أسعار الجملة للجميع مع خدمة التوصيل الفوري للناصرية والعامرية.
            </p>
            ...
            <div className="pt-2">
              <Link
                href="/products"
                className="bg-primary hover:bg-primary-dark text-white font-extrabold px-10 py-3.5 rounded-xl shadow-lg hover:shadow-primary/25 transition-all duration-300 transform hover:-translate-y-0.5 inline-block text-xs cursor-pointer"
              >
        ...
        <section className="py-12 bg-white border-b border-slate-200/60">
          <ScrollReveal className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-slate-50/50 border border-slate-100 p-6 rounded-2xl flex flex-col items-center md:items-start text-center md:text-right gap-3 shadow-xs hover:shadow-lg transition-all duration-350 hover:-translate-y-1 group">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-1 font-semibold leading-relaxed">تغطية شاملة لقطاع الفنادق، المطاعم، ومحلات التجزئة بأعلى معايير الجودة.</p>
                </div>
              </div>
              ...
              <div className="bg-slate-50/50 border border-slate-100 p-6 rounded-2xl flex flex-col items-center md:items-start text-center md:text-right gap-3 shadow-xs hover:shadow-lg transition-all duration-350 hover:-translate-y-1 group">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-1 font-semibold leading-relaxed">نوفر للبيوت والمحلات التجارية ميزة التسوق بسعر الجملة ابتداءً من 12 قطعة.</p>
                </div>
              </div>
              ...
              <div className="bg-slate-50/50 border border-slate-100 p-6 rounded-2xl flex flex-col items-center md:items-start text-center md:text-right gap-3 shadow-xs hover:shadow-lg transition-all duration-350 hover:-translate-y-1 group">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-1 font-semibold leading-relaxed">الوجهة الرسمية الموثوقة لخدمة أهالي الناصرية والعامرية بغرب الإسكندرية.</p>
                </div>
              </div>
      ...
      <section className="py-12 bg-white border-b border-slate-200/60">
        <ScrollReveal className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-center gap-5 overflow-x-auto pb-4 scrollbar-none">
            ...
            >
              <div className="w-16 h-16 sm:w-18 sm:h-18 rounded-full border border-slate-200 group-hover:border-primary flex items-center justify-center p-1.5 transition-all duration-300 bg-white shadow-xs group-hover:shadow-md">
        ...
        {loading ? (
          ...
          <div className="space-y-12">
            ...
            <div className="flex justify-center pt-4">
              <Link 
                href="/products"
                className="bg-primary hover:bg-primary-dark text-white font-extrabold px-10 py-3.5 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 inline-block text-xs"
              >
      ...
      <footer id="about" className="bg-[#111827] text-white pt-16 pb-8 border-t-4 border-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8 pb-12 border-b border-slate-800">
          ...
          <div className="space-y-4 text-right">
            ...
            <div className="space-y-2.5 text-xs text-slate-400 font-semibold">
              <p>📍 الإسكندرية، العامرية، الناصرية القديمة</p>
          ...
          <div className="space-y-4 text-right">
            ...
            <p className="text-xs text-slate-400 leading-normal font-semibold">سجل بريدك الإلكتروني لتصلك عروض المجمدات والبقالة الأسبوعية أولاً بأول.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 font-bold gap-4 text-center sm:text-right">
          <p>© {new Date().getFullYear()} الناصرية جملة ماركت. جميع الحقوق محفوظة.</p>
